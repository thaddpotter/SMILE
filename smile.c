...
//Singlepoint adaptive integration function
void adapt_integrate(){
...
//Management function for doing adaptive quadrature
void adaptquad(double pstar[2048], double u[2048], double init_curve[2048], float gamma, double errtol){
